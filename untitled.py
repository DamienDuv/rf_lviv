...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.center_freq = center_freq = 863.5e6
        ...
        self.osmosdr_source_0_0 = osmosdr.source(
            args="numchan=" + str(1) + " " + "hackrf=000000000000000066a062dc2b5a9b9f"
        )
        ...
        self.osmosdr_source_0 = osmosdr.source(
            args="numchan=" + str(1) + " " + "hackrf=0000000000000000437c63dc21857dd7"
        )
        ...
        self.blocks_sigmf_sink_minimal_0 = blocks.sigmf_sink_minimal(
            ...
            hw_info='',
            is_complex=True)
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'slave_data.bin', False)
        self.blocks_file_sink_0_0.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'master_data.bin', False)
        ...
        self.connect((self.osmosdr_source_0, 0), (self.blocks_sigmf_sink_minimal_0, 0))
        ...
        self.connect((self.osmosdr_source_0_0, 0), (self.qtgui_time_sink_x_0_0, 0))
