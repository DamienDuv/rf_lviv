...
class bladeRF2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "bladeRF2")
        ...
        self.c1_freq = c1_freq = 120e6
        self.c0_freq = c0_freq = 868e6
        ...
        self.osmosdr_source_0_1 = osmosdr.source(
            args="numchan=" + str(2) + " " + "bladerf=4a48b92853454f65b01d4c4ea9719309,nchan=2"
        )
        self.osmosdr_source_0_1.set_time_unknown_pps(osmosdr.time_spec_t())
        self.osmosdr_source_0_1.set_sample_rate(samp_rate)
        self.osmosdr_source_0_1.set_center_freq(c0_freq, 0)
        ...
        self.osmosdr_source_0_1.set_gain(50, 0)
        ...
        self.osmosdr_source_0_1.set_center_freq(c1_freq, 1)
        self.osmosdr_source_0_1.set_freq_corr(0, 1)
        self.osmosdr_source_0_1.set_dc_offset_mode(0, 1)
        self.osmosdr_source_0_1.set_iq_balance_mode(0, 1)
        self.osmosdr_source_0_1.set_gain_mode(False, 1)
        self.osmosdr_source_0_1.set_gain(10, 1)
        self.osmosdr_source_0_1.set_if_gain(20, 1)
        self.osmosdr_source_0_1.set_bb_gain(20, 1)
        self.osmosdr_source_0_1.set_antenna('', 1)
        self.osmosdr_source_0_1.set_bandwidth(0, 1)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.osmosdr_source_0_1, 0), (self.qtgui_freq_sink_x_0_1, 0))
        self.connect((self.osmosdr_source_0_1, 1), (self.qtgui_freq_sink_x_0_1_0, 0))
    ...
    def get_c1_freq(self):
        return self.c1_freq

    def set_c1_freq(self, c1_freq):
        self.c1_freq = c1_freq
        self.osmosdr_source_0_1.set_center_freq(self.c1_freq, 1)

    def get_c0_freq(self):
        return self.c0_freq

    def set_c0_freq(self, c0_freq):
        self.c0_freq = c0_freq
        self.osmosdr_source_0_1.set_center_freq(self.c0_freq, 0)




def main(top_block_cls=bladeRF2, options=None):
